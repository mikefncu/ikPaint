...
*/
class kpColorCellsBase : public QTableWidget // KOLOURPAINT_LGPL_EXPORT kpColorCellsBase : public QTableWidget
{
  Q_OBJECT
public:
  /**
...
public:
  ...
  */
  void setColor(int index, const QColor &col , const QString &name = QString());
